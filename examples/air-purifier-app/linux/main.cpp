...
#include <imgui_ui/windows/air_quality.h>
...
int main(int argc, char * argv[])
{
    ...
    ui.AddWindow(std::make_unique<example::Ui::Windows::AirQuality>(chip::EndpointId(AIR_QUALITY_SENSOR_ENDPOINT), "Air quality"));
