...
{
    UpdateStateEnum(mEndpointId, mTargetFanMode, mFanMode,
                    &chip::app::Clusters::FanControl::Attributes::FanMode::Set,
    ...
    UpdateStateReadOnly(mEndpointId, mTargetPercent, mPercent,
                        &chip::app::Clusters::FanControl::Attributes::PercentCurrent::Get);

    UpdateStateReadOnly(mEndpointId, mTargetSpeedMax, mSpeedMax,
                        &chip::app::Clusters::FanControl::Attributes::SpeedMax::Get);
    ...
    UpdateStateReadOnly(mEndpointId, mTargetFeatureMap, mFeatureMap,
                        &chip::app::Clusters::FanControl::Attributes::FeatureMap::Get);
...
void FanControl::Render()
{
    ...
    uint16_t featureMap   = mFeatureMap;
    ...
    ImGui::LabelText("Rock setting", "%s", GetRockBitmapValueString(rockSetting));
    if (!uiRockSetting.Has(rockSetting))
    {
        mTargetRockSetting.SetValue(uiRockSetting);
    }

    ImGui::LabelText("Wind setting", "%s", GetWindBitmapValueString(windSetting));
