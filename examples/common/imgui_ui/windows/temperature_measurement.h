...
private:
    ...
    int16_t mTemperatureMeasurementValue      = 0x7fff;
    int16_t mTemperatureMeasurementMin        = 0x7fff;
    int16_t mTemperatureMeasurementMax        = 0x7fff;
    uint16_t mTemperatureMeasurementTolerance = 0x7fff;
